...
public class StudentController {
    ...
    //chamando o UseCase ("StudentCertificationAnswerDTO")
    @Autowired
    private StudentCertificationAnswersUseCase studentCertificationAnswersUseCase;
    

    //verificar se usuario tem certificacao
    ...
    //Student Certification UseCase
    //"<Object>" -> podendo retornar diversas informações
